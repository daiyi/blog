...
{% figure src="sunrise-boulder.jpg" caption="Sunrise Boulder, with a view of Tenaya Peak" class="large" %}
...
{% figure src="summertime.jpg" caption="Views of Tenaya Peak from Summertime Boulder <3" %}
...
{% figure src="tenaya-lake-approach.jpg" caption="The Tenaya Lake beach approach!" %}
...
- Kauk problem v5 (The Knobs). this is the send that led me to finally believe I can climb v5. powerful, crimpy, precise moves (I guess this is my style??)
    ...
    {% figure src="kauk-problem.jpg" caption="The heel hook is key! Kauk Problem v5" class="small" %}
...
{% figure src="medlicott-approach.jpg" caption="Wandering between Medlicott boulders. So pretty!" class="large" %}
...
- Short Train v4 (Pywiak Boulder) - start horizontal and escape from a chilly creekside cave. very workable, kind of enduro. nice to have a couple pads for the talus-y landing. fun!
    ...
    {% figure src="short-train.jpg" caption="Pulling out of the streamside cave on Short Train v4" %}
- Summer Vacation v4 (Summertime Boulder) - it's a hike, and difficult to find, but the climb has unique granite features in a scenic location. another tuolumne escape-the-cave triller. Directions: Turn left (uphill) off the lake trail at (37.83242, -119.45311). Boulder is at (37.82888, -119.45279)
    ...
    {% figure src="summer-vacation-v4.jpg" caption="Summer Vacation v4 on Summertime boulder" class="small" %}
...
- Slopers and Dopers v4 (Drug Dome Trees) - another route with cool movement for granite
    ...
    {% figure src="slopers-and-dopers.jpg" caption="You know you're a granite climber when you full-crimp the shit out of a tiny crystal on a sloper! Slopers and Dopers v4" class="small" %}
- Unnamed v4 next to Detached (Medlicott Boulder)  - crimpy, technical sequencing and footwork, a bit overhanging, playing with body tension, funky visual feature. love it! 
    ...
    {% figure src="detached.png" caption="Unnamed v4 on Medlicott boulder" %}
- Unnamed v4 (Arena Boulder backside)  - overhanging lowball transitions into surprising mantle topout! more harder (tall) stuff on this boulder, including the ominous Buttermilks Simulator.
    ...
    {% figure src="arena.jpg" caption="Under the v4 and v6 of the backside of Arena boulder (you can see the car parked by the road)" %}
...
- Cave route v4 (Olmsted Canyon)  - very cool big moves between crimps under the roof felt SO hard. there's a wild mantle move at the top as a treat 
    ...
    {% figure src="cave-route.jpg" caption="Not your typical topout mantle on Cave Route v4" class="small" %}
...
{% figure src="dura-mater-slab.jpg" caption="Bravely climbing the v4 slab without pants protection! on Dura Mater boulder (behind Summertime Boulder)" %}
{% figure src="car-tesselation.jpg" caption="The summer of tessellating crash pads and friends into cars" %}

{% figure src="olmsted.jpg" caption="Someone forgot to pack jackets and had to use the car dog blanket! Early season problems at Olmsted Point Boulders (isn't that the trad cragging in the background?)" %}

{% figure src="the-seam-v8.jpg" caption="Team color-coordination at The Seam v8 - Medlicott Boulder"  %}

{% figure src="sun-hoodie-vibes.jpg" caption="Gotta keep that skin fresh"  %}

{% figure src="my-first-crash-pad.jpg" caption="Finally bought my first crash pad!! Thanks to my housemate Leo for the multi-year interest-free crash pad loan <3"  %}
