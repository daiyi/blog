...
{% figure src="scale.jpg" caption="Traffic at the u-pick watermelon truck scale?" class="" %}
...
{% figure src="watermelon-vanna.jpg" caption="How did I get here?" class="large" %}
...
{% figure src="watermelon-meimei.jpg" caption="" class="" %}
{% figure src="watermelon.jpg" caption="" class="" %}
</div>
...
<div class="photos large">
{% figure src="watermelon-bath.jpg" caption="" class="" %}
{% figure src="watermelon-cut.jpg" caption="" class="" %}
</div>
...
{% figure src="lake-siskiyou.jpg" caption="Smoke and orange light at Lake Siskiyou. Welcome to summer in California." class="" %}
...
{% figure src="mccloud-falls.jpg" caption="Upper McCloud Falls, cold and refreshing." class="large" %}
...
{% figure src="deschutes.jpg" caption="An otherwise quiet camp spot, minus the screaming birds." class="large" %}
...
{% figure src="lava-lake.jpg" caption="Lava Lake, calm with a bit of drizzle. Peaks left to right: South Sister, Broken Top, Mt Bachelor." class="large" %}
...
{% figure src="blow-lake.jpg" caption="Blow Lake, like a dream." class="large" %}
...
{% figure src="sunset.jpg" caption="Found a corral of vans outside of town and watched the sunset with the other campers." class="large" %}
...
{% figureMD src="monkeyface.jpg" class="large"  %}
...
{% figure src="hood-evening.jpg" caption="Dinner under Mt Hood" class="large" %}

{% figure src="hood-morning.jpg" caption="Breakfast under Mt Hood" class="large" %}
...
{% figure src="ski.jpg" caption="I wouldn't want to ski that??" class="large" %}
...
{% figure src="sando.jpg" caption="Representative sourdough avocado sando that we've been packing every day for lunch. Zigzag river in the back." class="" %}
...
{% figure src="farmer-coop.jpg" caption="Front row seat at the Farmer's Market." class="" %}
...
<div class="photos large">
{% figure src="punchbowl.jpg" caption="Devil's Punchbowl" class="" %}
{% figure src="eagle-creek-trail.jpg" caption="A little via ferrata on the way." class="" %}
</div>
...
{% figure src="mac.jpg" caption="The best part of traveling in a van is the freezer. We had daily ice cream" class="" %}
...
{% figure src="dip.jpg" class="large" %}